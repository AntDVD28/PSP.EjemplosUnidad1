...
package acceso_no_sincronizado;

import java.io.*;
/**
 * Clase para lanzar varios procesos que hagan uso del programa AccesoFichero.jar
 * No incluimos mecanismos de sincronización.
 * @author usuario
 */
        ...
        try{
            ...
            for (int i = 0; i <=20; i++){
                nuevoProceso = Runtime.getRuntime().exec("java -jar "+
                    "AccesoFichero.jar " + i + " fichero.txt");
